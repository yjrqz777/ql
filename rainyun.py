...
而2000积分就可以领取一个免费的MC服务器，而且可以用积分进行续费！续费也只需要2000积分！
...
class RainYun():
    ...
    def __init__(self, user: str, pwd: str) -> None:
        ...
        self.session.headers.update({
            ...
            "Origin": "https://api.v2.rainyun.com",
            "Referer": "https://api.v2.rainyun.com"
        })
    ...
    def login(self) -> None:
        ...
        res = self.session.post(
            url=self.login_url, headers={"Content-Type": "application/json"}, data=self.json_data,verify=False)
